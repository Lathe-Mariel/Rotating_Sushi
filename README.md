...
L型6角レンチ・セット．ホームセンターで売ってる7本組くらいの安いやつでOKです．筆者はPBかANEX（兼古製作所）が好きです．  
...
## マイコン or FPGA
ステッピング・モータのドライバはA4988です．このドライバ・ボードに指令を送るマイコン・ボードかFPGAボードが必要です．  
ArduinoとかESP32でいいんじゃないでしょうか？筆者はTang Nano 9Kか，Tang Primer 20Kでやっているので，sampleフォルダにプロジェクト一式が入っています．そのうちRX62Nも使うかもしれません．  
